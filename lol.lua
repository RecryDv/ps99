...
task.spawn(function()
	while task.wait(0.01) do
		game:GetService("VirtualInputManager"):SendKeyEvent(true, Enum.KeyCode.Unknown, false, game.Players.LocalPlayer.PlayerGui)
		task.wait(0.01)
		game:GetService("VirtualInputManager"):SendKeyEvent(false, Enum.KeyCode.Unknown, false, game.Players.LocalPlayer.PlayerGui)
	end
end)
